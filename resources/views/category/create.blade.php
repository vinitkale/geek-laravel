        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form method="POST" action="{{URL::to('category')}}" class="form-horizontal form-label-left">

                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Category Name <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="category-name" name="category_name" class="form-control col-md-7 col-xs-12" type="text"><ul class="parsley-errors-list">{{ $errors->category->first('category_name') }}</ul>
                                </div>
                            </div>
                            <div class="form-group">
