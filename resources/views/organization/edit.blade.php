                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="nav navbar-right panel_toolbox">
                            <a href="{{URL::to('organization/'.$organization->user_id)}}" type="button" class="btn btn-default btn-sm"><i class="fa fa-chevron-circle-left"></i> Back</a>
                         </div>
                        <div class="clearfix"></div>
                    </div>
                  
                        <br>
                        <form id="org-form" enctype="multipart/form-data" method="POST" action="{{url('organization/update')}}" class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                               ...
                               <input  class="form-control" value="{{ $organization->organization_name }}" name="organization_name" type="text">
                              ...
                              <input value="{{ $organization->organization_email }}" type="text" name="organization_email" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $organization->organization_website }}" name="organization_website" class="form-control">
                            ...
                            <div class="form-group">
                               <label for="email">Phone Number :</label>
                                <input id="organization_contact" data-inputmask="'mask' : '(999) 999-9999'" type="text" value="{{ $organization->organization_contact }}" name="organization_contact" class="form-control">
                            ...
                            <div class="x_content">
                             <div class="form-group">
                               ...
                               <label for="fullname">Country :</label>
                                ...
                                <select class="form-control" id="country" name="country" data-placeholder="Choose a Country..." style="width:100%;" tabindex="1">
                                    ...
                                    <option <?php echo ($organization->country == $count_val->id) ? "selected" : ''; ?> value="{{ $count_val->id }}">{{ $count_val->name }}</option>
                                    @endforeach;
                                </select>
                             ...
                             <div class="form-group">
                              ...
                              <textarea class="form-control" name="organization_location">{{ $organization->organization_location }}</textarea>
                            ...
                            <input type="hidden" name="old_organization_logo" value="{{ $organization->organization_logo}}">
                            </div>
                             </div>
                             <div class="clearfix"></div> </br>
                        <div class="col-md-12 col-xs-12">
                            <label class="control-label">About the Organization* :</label></br></br>
                             <textarea class="ckeditor form-control" name="organization_description" rows="6">{{ $organization->organization_description }}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-10  pull-left">
                                    ...
                                    <a href="{{URL::to('organization/'.$organization->user_id)}}" class="btn btn-primary">Cancel</a>
        ...
        var state = $("#state");
                ...
                type: 'POST',
                        ...
                        $(state).append('<option value="' + value.state_id + '">' + value.name + '</option>');
                                ...
                                var state_id = ('{{$organization->state}}');
                                getCity(state_id);
                        } else{
                                state.empty();
                                $(state).trigger("chosen:updated");
